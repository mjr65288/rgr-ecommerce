...
export default function CurrencyForm({
  ...
  useEffect(() => {
    const validCodes = ([{ name: 'United States Dollar', code: 'USD', symbol: '$', convertRate: 1 }, { name: 'Mexican Peso', code: 'MXN', symbol: '$', convertRate: 17.25 }]).map((lang) => lang.code)
            ...
            <FormItem>
              ...
              <FormControl>
                ...
                >
                  ...
                  <SelectContent>
                    {([{ code: 'USD', name: 'United States Dollar' }, { code: 'MXN', name: 'Mexican Peso' }])
                      .filter((x) => x.code)
                      .map((lang, index) => (
